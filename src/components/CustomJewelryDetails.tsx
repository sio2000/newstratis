    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="relative mb-16 lg:mb-20 mt-8"
        >
          {/* Background Image */}
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-2xl lg:rounded-3xl overflow-hidden">
            <img
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white max-w-4xl mx-auto px-4 lg:px-6">
                <motion.div
                ...
                <motion.h1
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-serif font-bold mb-4 lg:mb-6 leading-tight drop-shadow-2xl"
                >
                ...
                <motion.p
                  ...
                  className="text-base sm:text-lg lg:text-xl text-white/90 max-w-2xl lg:max-w-3xl mx-auto leading-relaxed drop-shadow-lg"
                >
                  {language === 'en' 
        ...
        <div className="mb-20 lg:mb-32 relative">
          ...
          <div className="text-center mb-16 lg:mb-24 relative z-10">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              className="inline-flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6 mb-8"
            >
              <div className="w-20 h-20 lg:w-28 lg:h-28 bg-gradient-to-br from-gold via-yellow-400 to-amber-500 rounded-full flex items-center justify-center shadow-2xl shadow-gold/40 border-2 lg:border-4 border-white/20 relative overflow-hidden">
                <Crown className="h-10 w-10 lg:h-14 lg:w-14 text-black drop-shadow-lg" />
              ...
              <div className="text-center lg:text-left">
                <span className="text-gold text-xl lg:text-4xl font-medium uppercase tracking-wider lg:tracking-widest bg-black/60 backdrop-blur-md px-6 lg:px-10 py-4 lg:py-6 rounded-2xl lg:rounded-3xl border-2 border-gold/40 shadow-2xl">
              ...
              {processDetails.map((step, index) => (
                ...
                >
                  ...
                  <div className="absolute -top-4 -left-4 z-20">
                    <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-gold via-yellow-400 to-amber-500 rounded-full flex items-center justify-center shadow-2xl shadow-gold/40 border-2 lg:border-4 border-white/20 relative overflow-hidden">
                      <span className="text-black font-bold text-lg lg:text-2xl drop-shadow-lg">{index + 1}</span>
                      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-white/30 to-transparent opacity-60"></div>
                    </div>
                  </div>
                    ...
                    <div className="relative p-1 rounded-2xl lg:rounded-3xl bg-gradient-to-br from-gold/30 via-yellow-400/20 to-amber-500/10 shadow-2xl shadow-gold/30 border border-gold/40 overflow-hidden">
                      <div className="bg-white/95 backdrop-blur-md rounded-2xl lg:rounded-3xl p-6 lg:p-12 h-full relative border border-gray-200">
                        ...
                        <div className="absolute inset-0 opacity-5">
                          ...
                          <div className={`absolute bottom-8 left-8 w-20 h-20 lg:w-40 lg:h-40 bg-gradient-to-br ${step.color} rounded-full blur-2xl animate-pulse`} style={{ animationDelay: '1s' }}></div>
                        </div>
                        ...
                        <div className="relative z-10 mb-6 lg:mb-8">
                          <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-6 mb-6">
                            <div className={`w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br ${step.color} rounded-xl lg:rounded-2xl flex items-center justify-center shadow-xl border-2 border-white/20 relative overflow-hidden`}>
                              <step.icon className="h-8 w-8 lg:h-10 lg:w-10 text-white drop-shadow-lg" />
                              <div className="absolute inset-0 rounded-xl lg:rounded-2xl bg-gradient-to-br from-white/20 to-transparent opacity-60"></div>
                            </div>
                            <div>
                              <h4 className="text-2xl lg:text-4xl font-serif font-bold text-gold mb-3 group-hover:text-yellow-400 transition-colors duration-500">
                                {step.title}
                              </h4>
                              <div className="w-20 lg:w-24 h-1 bg-gradient-to-r from-gold to-transparent"></div>
                            </div>
                          </div>
                        </div>
                        ...
                        {/* Hover Effects */}
                        <div className="absolute inset-0 rounded-2xl lg:rounded-3xl border-2 border-transparent group-hover:border-gold/60 transition-all duration-700 opacity-0 group-hover:opacity-100"></div>
                        
                        {/* Glow Effect */}
                        <div className={`absolute inset-0 rounded-2xl lg:rounded-3xl bg-gradient-to-br ${step.color} opacity-0 group-hover:opacity-5 transition-opacity duration-700`}></div>
                      </div>
                    </div>

                    {/* Luxury Image Overlay - Repositioned for mobile */}
                    <div className={`absolute ${index === 3 ? '-bottom-6 lg:-bottom-8 -right-6 lg:-right-8' : '-bottom-4 lg:-bottom-6 -right-4 lg:-right-6'} z-10`}>
                      <motion.div
                      ...
                      >
                        <div className={`${index === 3 ? 'w-24 h-24 lg:w-32 lg:h-32' : 'w-28 h-28 lg:w-36 lg:h-36'} rounded-xl lg:rounded-2xl overflow-hidden shadow-2xl shadow-gold/30 border-2 border-gold/40 group-hover:border-gold/60 transition-all duration-500 transform group-hover:rotate-2 group-hover:scale-105`}>
                          <img
                            src={step.image}
                        ...
                        <div className="absolute -top-2 lg:-top-3 -right-2 lg:-right-3 w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-gold to-yellow-400 rounded-full flex items-center justify-center shadow-lg border-2 border-white/20">
          ...
          >
            <div className="inline-flex items-center space-x-4 lg:space-x-8">
              <div className="w-3 h-3 lg:w-4 lg:h-4 bg-gold rounded-full animate-pulse"></div>
              <div className="w-6 h-6 lg:w-8 lg:h-8 bg-gold rounded-full animate-pulse" style={{ animationDelay: '0.3s' }}></div>
              <div className="w-8 h-8 lg:w-12 lg:h-12 bg-gold rounded-full animate-pulse" style={{ animationDelay: '0.6s' }}></div>
              <div className="w-6 h-6 lg:w-8 lg:h-8 bg-gold rounded-full animate-pulse" style={{ animationDelay: '0.9s' }}></div>
              <div className="w-3 h-3 lg:w-4 lg:h-4 bg-gold rounded-full animate-pulse" style={{ animationDelay: '1.2s' }}></div>
            </div>
            
            {/* Luxury Divider */}
            <div className="mt-8 lg:mt-12 flex items-center justify-center space-x-4 lg:space-x-6">
              <div className="w-16 lg:w-24 h-px bg-gradient-to-r from-transparent via-gold to-transparent"></div>
              <div className="w-4 h-4 lg:w-6 lg:h-6 bg-gradient-to-br from-gold to-yellow-400 rounded-full shadow-lg"></div>
              <div className="w-16 lg:w-24 h-px bg-gradient-to-r from-transparent via-gold to-transparent"></div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-16 lg:mb-24">
          <h3 className="text-2xl lg:text-3xl font-serif font-bold text-gold text-center mb-12 lg:mb-16">
